...
function wp_job_manager_shortwidget_init_slider(){
	jQuery('.slider').remove();
	jQuery('.wp_job_manager_shortwidget_simple_slider').each(function(k,v){
		var slide = jQuery(v);
		slide.simpleSlider({
...
jQuery(function($){
	//wp_job_manager_shortwidget_field_callbacks.push('wp_job_manager_shortwidget_init_slider');
	wp_job_manager_shortwidget_init_slider();
	$(document).ajaxSuccess(function(e, xhr, settings) {
		if(settings.data){
			if(settings.data.search('action=save-widget') != -1 && settings.data.search('wp_job_manager_shortwidget') != -1) {
				wp_job_manager_shortwidget_init_slider();
			}
		}
	});
